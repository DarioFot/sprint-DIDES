function moveElements() {
  ...
  noseElement.style.transform = "translateY(-80px)";
...
function addTextAfterDelay() {
  ...
  setTimeout(function () {
    textElement.style.transition = "opacity 0.6s ease-in-out"; // Übergangseigenschaften für die Opazität setzen
...
function changeBackground() {
  ...
  switch (currentImage) {
    ...
    case 'url("links/2.22_star.png")':
      ...
      starsContainer.style.transform = "translateY(-6dvh)";
